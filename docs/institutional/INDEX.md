# Institutional artefact templates + reviewer Q&A

These templates are the architect's tools for unlocking Phase-2
...
| [`UNDP-QA.md`](./UNDP-QA.md)                                               | UNDP technical reviewer (also reusable for AfDB / World Bank / IMF / EU Delegation / GIZ / OAPI / ARMP / CONAC / ANIF technical staff) | Pre-answered due-diligence Q&A pack covering mandate, sovereignty, architecture, ingestion, the 43 fraud patterns, AI safety, cryptography, audit chain, privacy, governance, resilience, compliance, costs, verifiability, and stated limitations                                                                                          | provides ready answers when an institutional reviewer requests a technical deep-dive (no scheduling phase gate, but expected before any Phase-2 funding ask) |
| [`HOW-IT-WORKS.md`](./HOW-IT-WORKS.md)                                     | Anyone — engineer, lawyer, journalist, council member, citizen — who wants the complete platform walkthrough from first principles     | Single linear read explaining every app, every worker, the 43 patterns, the Bayesian certainty engine, the 12-layer AI safety stack, Shamir + YubiKey + libsodium, the 5-pillar council, the triple-witness audit chain, RBAC, the tip portal, the dossier journey, operations, failure modes, verifiability, stated limits, and a glossary | the canonical "how the system works" reference; first artefact handed to any new reviewer, journalist briefing, or council-candidate read-through            |
